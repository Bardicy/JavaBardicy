...
public class CompareNumbers {
	...
	public static void main(String[] args) {
		...
		System.out.println("--------------diff example----------");
		
		//declare variable for a day and the based on the value
		...
		if(day==1) {
			...
			System.out.println("It is Wednesday, we have SDLC Class again");
		}else if(day==4) {
			System.out.println("It's Thursday, we have our Review Class");
		}else if(day==5) {
